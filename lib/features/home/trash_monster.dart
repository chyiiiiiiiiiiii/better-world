                          ...
                          builder: (context, value, _) {
                            return ZIllustration(
                              children: [
                                ZPositioned(
                                  ...
                                  child: ZShape(
                                    path: [
                                      ...
                                      ZLine.only(
                                          x: -10, y: 0), // line to bottom left
                                      ZLine.only(
                                          x: 32, y: 0), // line to bottom right
                                      ZLine.only(
                                          x: -10, y: 50), // line to bottom left
                                      ZLine.only(
                                          x: -5, y: 25), // line to bottom right
                                      ZLine.only(
                                          x: -55,
                                          y: 25), // line to bottom right
                                    ],
                                    closed: true,
                                    stroke: 10,
                                    color:
                                ...
                                ZPositioned(
                                  translate:
                                      ZVector(-90, -100 + (value / 2), 0),
                                  rotate: ZVector(10.toRadians(),
                                      180.toRadians(), 30.0.toRadians()),
                      ...
                      child: FadeOutParticle(
                        ...
                        child: Column(
                          ...
                          children: [
                            Sprite(
                              imagePath:
                                  'assets/trash_sprite/trash_$monsterNumber.png',
